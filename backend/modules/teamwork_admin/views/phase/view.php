...
<div class="phase-view">
    ...
    <h3>环节</h3>
    <p>
        <?= Html::a(Yii::t('rcoa/teamwork', 'Create Link'), ['/teamwork_admin/link/create','phase_id' => $model->id],['class' => 'btn btn-success']) ?>
    </p>
                ...
                'buttons' => [
                    'update' => function ($url, $model, $key) {
                        ...
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', 
                            ['/teamwork_admin/link/update', 'id' => $model->id], $options);
                    },
                    'delete' => function ($url, $model, $key) {
                        ...
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', 
                            ['/teamwork_admin/link/delete', 'id' => $model->id], $options);
                    },       
                ],
