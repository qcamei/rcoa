...
/* @var $model common\models\demand\searchs\DemandWorkitemTemplateSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="demand-workitem-template-search">
    ...
    <?= $form->field($model, 'demand_workitem_template_type_id') ?>
