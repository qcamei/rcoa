...
namespace backend\modules\product_admin\controllers;
...
;            return $this->render('create', [
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('update', [
                'model' => $model,
                'productType' => $this->getProductType(),
                'classification' => $this->getProductClassification($model->id)
            ]);
        }
    }
    ...
    {
        return ArrayHelper::map(ProductType::findAll(['is_delete' => 'N']), 'id', 'name');
    }
    ...
    {
       $classification = Product::find()
                        ->where(['level' => Product::CLASSIFICATION])
