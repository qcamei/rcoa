...
<div class="phase-view">
    ...
    <h3>环节</h3>
    <p>
        <?= Html::a(Yii::t('rcoa/framework', 'Create Link'), ['/framework/link/create','phase_id' => $model->id],['class' => 'btn btn-success']) ?>
    </p>
                ...
                'buttons' => [
                    'update' => function ($url, $model, $key) {
                        ...
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', 
                            ['/framework/link/update', 'id' => $model->id], $options);
                    },
                    'delete' => function ($url, $model, $key) {
                        ...
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', 
                            ['/framework/link/delete', 'id' => $model->id], $options);
                    },       
                ],
