...
<div class="phase-link-view">
    ...
    <p>
        <?= Html::a(Yii::t('rcoa/framework', 'Update'), ['update', 'phases_id' => $model->phases_id, 'link_id' => $model->link_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('rcoa/framework', 'Delete'), ['delete', 'phases_id' => $model->phases_id, 'link_id' => $model->link_id], [
