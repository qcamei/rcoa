...
/**
 * WorksystemOperationUserSearch represents the model behind the search form about `common\models\worksystem\WorksystemOperationUser`.
 */
class WorksystemOperationUserSearch extends WorksystemOperationUser
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = WorksystemOperationUser::find();
