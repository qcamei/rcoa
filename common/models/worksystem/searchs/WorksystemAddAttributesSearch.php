...
/**
 * WorksystemAddAttributesSearch represents the model behind the search form about `common\models\worksystem\WorksystemAddAttributes`.
 */
class WorksystemAddAttributesSearch extends WorksystemAddAttributes
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = WorksystemAddAttributes::find();
