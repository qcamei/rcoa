...
/**
 * McbsCourseChapterSearch represents the model behind the search form about `common\models\mconline\McbsCourseSection`.
 */
class McbsCourseSectionSearch extends McbsCourseSection
{
    ...
    public function search($params)
    {
        ...
        $query = McbsCourseSection::find()->from(['CourseSection'=> McbsCourseSection::tableName()]);
        ...
        $query->where(['CourseSection.is_del' => 0]);
