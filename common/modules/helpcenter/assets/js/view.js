...
$("#thumbs-up").click(function () {
    ...
    if (isAdd === "false") {
        $.post("/helpcenter/api/post-like", $("#thumbs-up-form").serialize(), function (datar) {
            if (datar['code'] === 200) {
        ...
        $.post("/helpcenter/api/cancel-post-like", $("#thumbs-up-form").serialize(), function (datar) {
            if (datar['code'] === 200) {
...
$("#thumbs-down").click(function () {
    var isAdd = $(this).attr("data-add");
    if (isAdd === "false") {
        $.post("/helpcenter/api/post-unlike", $("#thumbs-down-form").serialize(), function (datar) {
            if (datar['code'] === 200) {
        ...
        $.post("/helpcenter/api/cancel-post-unlike", $("#thumbs-down-form").serialize(), function (datar) {
            if (datar['code'] === 200) {
