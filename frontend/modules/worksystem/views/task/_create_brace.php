    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">寻求支撑</h4>
            </div>
            <div class="modal-body">
                ...
                <?= Html::activeHiddenInput($model, 'is_brace', ['value' => WorksystemTask::SEEK_BRACE_MARK]); ?>
                <?= Html::activeHiddenInput($model, 'status', ['value' => WorksystemTask::STATUS_WAITASSIGN])?>
                <?= Html::activeHiddenInput($model, 'progress', ['value' => WorksystemTask::$statusProgress[WorksystemTask::STATUS_WAITASSIGN]])?>
