    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= Html::activeHiddenInput($model, 'status', ['value' => WorksystemTask::STATUS_ADJUSTMENTING])?>
                <?= Html::activeHiddenInput($model, 'progress', ['value' => WorksystemTask::$statusProgress[WorksystemTask::STATUS_ADJUSTMENTING]])?>
