    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">取消外包</h4>
            </div>
            <div class="modal-body">
                ...
                <?= Html::activeHiddenInput($model, 'is_epiboly', ['value' => WorksystemTask::CANCEL_EPIBOLY_MARK]); ?>
                <?= Html::activeHiddenInput($model, 'status', ['value' => WorksystemTask::STATUS_CHECKING])?>
                <?= Html::activeHiddenInput($model, 'progress', ['value' => WorksystemTask::$statusProgress[WorksystemTask::STATUS_CHECKING]])?>
