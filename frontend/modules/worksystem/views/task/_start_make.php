    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">开始制作</h4>
            </div>
            <div class="modal-body">
                ...
                <?= Html::encode('是否确定开始制作？') ?>
                
                <?= Html::activeHiddenInput($model, 'status', ['value' => WorksystemTask::STATUS_WORKING])?>
                <?= Html::activeHiddenInput($model, 'progress', ['value' => WorksystemTask::$statusProgress[WorksystemTask::STATUS_WORKING]])?>
