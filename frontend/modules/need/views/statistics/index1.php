...
<div class="container statistics-content">
    <div class="btn-group">
        <?php echo Html::a("按学时统计", Url::to('/need/statistics?type=0'), ['class'=>"btn btn-default".($type == 0 ? ' active': '')]); ?>
        <?php echo Html::a('按花费统计', Url::to('/need/statistics?type=1'), ['class'=>'btn btn-default'.($type == 1 ? ' active': '')]); ?>
    </div>
    <hr/> 
