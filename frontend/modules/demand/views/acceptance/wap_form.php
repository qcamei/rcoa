                    ...
                    <tbody>
                        ...
                        <tr class="tr">
                            ...
                            <td class="text-center">
                                ...
                                <div class="col-lg-6 col-md-7 col-sm-7 col-xs-6">数量</div>
                                <div class="col-lg-6 col-md-7 col-sm-7 col-xs-6">质量</div>
                                <?php endif; ?>
                            </td>
                        </tr>
                            <?php foreach ($workitem as $work): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" rowspan="<?= $number[$type['id']] ?>">
                                        ...
                                        <div class="col-lg-6 col-md-7 col-sm-7 col-xs-6" style="margin-top: 25px;">
                                            <?= Slider::widget([
