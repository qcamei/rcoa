...
<div class="controlbar">
    <div class="container">
        ...
        <?php
             ...
             * 5、必须是【开发管理员】
             */
            if($model->getIsNormal() &&  ((Yii::$app->user->can(RbacName::PERMSSION_TEAMWORK_TASK_UPDATE) && $model->create_by == Yii::$app->user->id) 
             ...
             * 5、必须是【开发管理员】
             */
            if($model->getIsWaitStart() && ((Yii::$app->user->can(RbacName::PERMSSION_TEAMWORK_TASK_UPDATE) && $model->create_by == Yii::$app->user->id) 
               || $twTool->getIsAuthority('id', $model->course_principal) || $rbacManager->isRole(RbacName::ROLE_TEAMWORK_DEVELOP_MANAGER, Yii::$app->user->id)))
            ...
            if($rbacManager->isRole(RbacName::ROLE_TEAMWORK_DEVELOP_MANAGER, Yii::$app->user->id))
            {
                 ...
                 * 3、必须是【开发管理员】
                 */
                if(Yii::$app->user->can(RbacName::PERMSSION_TEAMWORK_COURSE_TRANSFER) && $model->getIsNormal())
                 ...
                 * 3、必须是【开发管理员】
                 */
                if(Yii::$app->user->can(RbacName::PERMSSION_TEAMWORK_COURSE_RESTORE) && $model->getIsCarryOut())
