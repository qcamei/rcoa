 ...
 * @since 2.0
 */
class ItemListGridView extends BaseListView
{
    ...
    public $emptyCell = '&nbsp;';
    /**
     * @var Model the model that keeps the user-entered filter data. When this property is set,
    ...
    public function renderTableBody()
    {
        ...
        if (empty($rows)) {
            ...
            return "<tbody>\n<a><tr><td colspan=\"$colspan\">" . $this->renderEmpty() . "</td></tr></a>\n</tbody>";
        } else {
            return "<tbody>\n" . implode("\n", $rows) . "\n</tbody>";
        }
    }
    ...
    public function renderTableRow($model, $key, $index)
    {
        ...
        return Html::tag('a', Html::tag('tr', implode('', $cells), $options),  $this->rowOptions);
    }
